...
export function TestEmailButton() {
  ...
  const handleTestEmail = async () => {
    ...
    try {
      ...
      setResult({
        success: true,
        message: `Email enviado correctamente desde ${process.env.NEXT_PUBLIC_SENDER_EMAIL || "envios@asertiva.com.ar"}. 
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">
        Dirección del remitente: {process.env.NEXT_PUBLIC_SENDER_EMAIL || "envios@asertiva.com.ar"}
      </p>
    </div>
  )
}
